     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e285d1682d00=explode(',',$maccms['search_hot']); if(is_array($_5e285d1682d00) || $_5e285d1682d00 instanceof \think\Collection || $_5e285d1682d00 instanceof \think\Paginator): if( count($_5e285d1682d00)==0 ) : echo "" ;else: foreach($_5e285d1682d00 as $key=>$vo): if($key < 5): ?>
