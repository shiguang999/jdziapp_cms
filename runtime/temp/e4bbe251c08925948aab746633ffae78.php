     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e540aff114c5=explode(',',$maccms['search_hot']); if(is_array($_5e540aff114c5) || $_5e540aff114c5 instanceof \think\Collection || $_5e540aff114c5 instanceof \think\Paginator): if( count($_5e540aff114c5)==0 ) : echo "" ;else: foreach($_5e540aff114c5 as $key=>$vo): if($key < 5): ?>
