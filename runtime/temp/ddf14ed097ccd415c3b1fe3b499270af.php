     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e2e30430455c=explode(',',$maccms['search_hot']); if(is_array($_5e2e30430455c) || $_5e2e30430455c instanceof \think\Collection || $_5e2e30430455c instanceof \think\Paginator): if( count($_5e2e30430455c)==0 ) : echo "" ;else: foreach($_5e2e30430455c as $key=>$vo): if($key < 5): ?>
