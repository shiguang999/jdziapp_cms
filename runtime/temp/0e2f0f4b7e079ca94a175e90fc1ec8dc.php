     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e37c3c518146=explode(',',$maccms['search_hot']); if(is_array($_5e37c3c518146) || $_5e37c3c518146 instanceof \think\Collection || $_5e37c3c518146 instanceof \think\Paginator): if( count($_5e37c3c518146)==0 ) : echo "" ;else: foreach($_5e37c3c518146 as $key=>$vo): if($key < 5): ?>
