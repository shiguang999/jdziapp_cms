...
<div id="full-container">
	...
	<?php
        ...
        ?>
												...
												<div class="download">
													<img src="images/code.png" class="code animated"
														 style="animation-delay:0s;">
													<div class="downloadBtn">
														<a class="button rounded button-android animated" style="animation-delay:0.7s;" href="http://ys.jdzi.vip/app/download/jdzi/android/jdzi.apk">
															安卓版下载
														</a>

														<a class="button rounded button-ios animated" style="animation-delay:0.8s;" href="#" >
															苹果版下载
														</a>
													</div>
												</div>
