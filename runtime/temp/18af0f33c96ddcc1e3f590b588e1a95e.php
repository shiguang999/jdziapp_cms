     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e3374b6a2658=explode(',',$maccms['search_hot']); if(is_array($_5e3374b6a2658) || $_5e3374b6a2658 instanceof \think\Collection || $_5e3374b6a2658 instanceof \think\Paginator): if( count($_5e3374b6a2658)==0 ) : echo "" ;else: foreach($_5e3374b6a2658 as $key=>$vo): if($key < 5): ?>
