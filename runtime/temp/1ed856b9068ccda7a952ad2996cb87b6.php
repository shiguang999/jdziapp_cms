     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e287459b466c=explode(',',$maccms['search_hot']); if(is_array($_5e287459b466c) || $_5e287459b466c instanceof \think\Collection || $_5e287459b466c instanceof \think\Paginator): if( count($_5e287459b466c)==0 ) : echo "" ;else: foreach($_5e287459b466c as $key=>$vo): if($key < 5): ?>
