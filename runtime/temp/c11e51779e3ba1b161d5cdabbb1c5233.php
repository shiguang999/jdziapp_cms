     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e2bdd2875b83=explode(',',$maccms['search_hot']); if(is_array($_5e2bdd2875b83) || $_5e2bdd2875b83 instanceof \think\Collection || $_5e2bdd2875b83 instanceof \think\Paginator): if( count($_5e2bdd2875b83)==0 ) : echo "" ;else: foreach($_5e2bdd2875b83 as $key=>$vo): if($key < 5): ?>
        ...
        <!-- 筛选 -->
			<div class="art_navlist" id="hl01">
				...
				<ul class="clearfix">
					...
					<li <?php if(($vo['type_id'] == $GLOBALS['type_id'])): ?>class="active conch-01"<?php endif; ?>><a href="<?php echo mac_url_type($vo); ?>"><?php echo $vo['type_name']; ?>首页</a></li>
					...
					<li <?php if(($vo['type_id'] == $GLOBALS['type_id'] || $vo['type_id'] == $GLOBALS['type_pid'])): ?>class="active conch-01"<?php endif; ?>><a href="<?php echo mac_url_type($vo); ?>" class="text_muted"><?php echo $vo['type_name']; ?></a></li>
...
<li class="artbanner_item swiper-slide">  
	<div class="artbanner_img">
		<a class="artbanner_thumb swiper-lazy" href="<?php echo mac_url_art_detail($vo); ?>" title="<?php echo $vo['art_name']; ?>" data-background="<?php echo mac_url_img($vo['art_pic']); ?>">						
			<span class="artbanner_title"><?php echo $vo['art_name']; ?></span>
	    </a>
	</div>
</li>
...
<li class="artlist_item no_artpic">  
    <div class="artlist_txt">	
	     <h4 class="artlist_title"><a href="<?php echo mac_url_art_detail($vo); ?>" title="<?php echo $vo['art_name']; ?>"><?php echo $vo['art_name']; ?></a></h4>
	     <p class="artzy hidden_xs"><?php echo $vo['art_blurb']; ?></p>
	     <p class="artty"><?php if(($maccms['aid'] == 1) OR ($obj['type_id'] == 5)): ?><span class="name_text<?php echo $vo['type']['type_id']; ?> pic_text text_right"><?php echo $vo['type']['type_name']; ?></span><?php endif; ?><span><?php echo mac_friend_date($vo['art_time']); ?></span><span class="artyd"><?php echo $vo['art_hits']; ?>阅读</span></p>
    </div>		
</li>
<?php else: ?>
		...
		<div class="art_sider_row hidden_xs hidden_mi">
            <div class="pannel clearfix">
				...
				<ul class="ranklist_r clearfix">
					<?php $__TAG__ = '{"num":"6","paging":"no","type":"all","level":"9","order":"desc","by":"sort","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
					<li class="part_eone">
