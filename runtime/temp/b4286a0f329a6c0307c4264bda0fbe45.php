     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e285fca65394=explode(',',$maccms['search_hot']); if(is_array($_5e285fca65394) || $_5e285fca65394 instanceof \think\Collection || $_5e285fca65394 instanceof \think\Paginator): if( count($_5e285fca65394)==0 ) : echo "" ;else: foreach($_5e285fca65394 as $key=>$vo): if($key < 5): ?>
